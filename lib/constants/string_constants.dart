class StringConstants {
  ...
  static const String PASSWORD_ERROR = "Password length must be 8 containing only letters, digits and underscores";
  ...
  static const String CHANGE_PASSWORD_BUTTON = "CHANGE PASSWORD";
  static const String NEW_PASSWORD_HINT = "New password";
  static const String NEW_PASSWORD_2_HINT = "Reenter new password";
  static const String CURRENT_PASSWORD_HINT = "Enter current password";
  ...
  static const String TOS_P_1 = "Please read these terms of use carefully (\"Terms\"). These Terms govern and apply to your access and ongoing use of cherished  prayers. By accessing or using our Service, you agree to be bound by all of the terms and conditions described in these Terms. If you are agreeing to these Terms on behalf of a company or other legal entity, you represent that you have the authority to bind such entity to these Terms. If you do not agree to any or all of these terms and conditions, you may not use our Service.";
  static const String TOS_H_2 = "Use of the Service";
  static const String TOS_P_2 = "Cherished Prayers allows you to access and view content through our mobile and web-based applications, as well as our website (each individually an “App”). As long as you comply with these Terms, you have the right to download and install a copy of the App to your mobile device, and Cherished Prayers grants you a limited, non-exclusive, non-transferable and revocable license to access and use the Service, for your own personal use.";
  static const String TOS_P_3 = "You may not:";
  static const List<String> LIST_TOS = [
    "Copy, modify or distribute the App for any purpose.",
    "Transfer, sublicense, lease, sell, resell, lend, rent or otherwise distribute the App or the Service to any third party.",
    "Decompile, reverse-engineer, disassemble, or create derivative works of any portion of the App or the Service or attempt to discover any source code or underlying ideas or algorithms of the Service.",
    ...
    "Make the functionality of the App or the Service available to any third party or multiple users through any means.",
    "Use the Service to transmit material in violation of third party privacy rights.",
